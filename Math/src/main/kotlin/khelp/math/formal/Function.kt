...
abstract class Function : Comparable<Function>
{
    companion object
    {
         ...
         */
        fun createAddition(functions : SortedArray<Function>) : Function =
            when (functions.size)
            {
                0    -> Constant.ZERO
                1    -> functions[0]
         ...
         * @return Multiplication created
         */
        fun createMultiplication(functions : SortedArray<Function>) : Function =
            when (functions.size)
            {
                0    -> Constant.ZERO
                1    -> functions[0]
    ...
    fun simplify() : Function =
        ...
        else this.obtainFunctionSimplifier()
            .simplify()
