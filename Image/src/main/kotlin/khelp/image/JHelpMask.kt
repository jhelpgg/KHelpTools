...
import khelp.io.extensions.readByteArray
import khelp.io.extensions.readInt
import khelp.io.extensions.writeByteArray
import khelp.io.extensions.writeInt
import khelp.ui.font.JHelpFont
import khelp.utilities.extensions.and
import khelp.utilities.extensions.or
...
class JHelpMask internal constructor(val width : Int, val height : Int, private val data : ByteArray)
{
    ...
    {
        val font = JHelpFont(family, min(this.width, this.height))
        val string = character.toString()

        val shape = font.shape(string, 0, 0)
    ...
    fun save(outputStream : OutputStream)
    {
        ...
        outputStream.writeByteArray(this.data)
    }
...
fun loadMask(inputStream : InputStream) : JHelpMask
{
    ...
    val data = inputStream.readByteArray()
